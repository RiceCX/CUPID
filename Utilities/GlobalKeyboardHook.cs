...
namespace CUPID.Utilities {
    class GlobalKeyboardHook {
        ...
        public delegate int keyboardHookProcess(int code, int wParam, ref keyboardHookStruct lParam);
        /// <summary>
        ...
        private static keyboardHookProcess callbackDelegate;

        public void hook() {
            if (callbackDelegate != null) throw new InvalidOperationException("Can't hook more than once");
            IntPtr hInstance = LoadLibrary("User32");
            callbackDelegate = new keyboardHookProcess(hookProc);
